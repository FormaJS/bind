...
describe('rhfBinder', () => {
  ...
  it('throws error for invalid schema', () => {
    ...
    expect(() => rhfBinder({ validate: 'not a function' })).toThrow('rhfBinder requires a mold schema');
  });
  ...
  it('handles deeply nested structures', async () => {
    ...
    expect(result.values).toEqual({});
    expect(result.errors['company.departments.0.manager.contact.email']).toBeDefined();
